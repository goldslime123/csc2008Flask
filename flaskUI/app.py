...
def index():
    ...
    data = [
        ("2015-Q1", 23.29, 25.6, 27.4),
        ("2015-Q2", 20.87, 25.6, 28.8),
        ("2015-Q3", 22.41, 25.6, 28.7),
        ("2015-Q4", 20.35, 27.9, 28.1),
        ("2016-Q1", 19.5, 27.9, 28.4),
        ("2016-Q2", 17.68, 27.9, 29.1),
        ("2016-Q3", 19.28, 27.9, 27.7),
        ("2016-Q4", 19.13, 27.9, 27.1),
        ("2017-Q1", 20.2, 24.2, 28.3),
    ]
    ...
    return render_template("index.html", labels=labels, electricPrice=electricPrice, crudePrice=crudePrice, temperature=temperature )
