...
# import data set
datasetTemp = pd.read_csv('../csv/products/crudeoil.csv')
...
print("Predicted Crude Oil: 2022 Quarter 1: " + str(y))
...
plt.title('Crude Oil vs Tariff (Training set)')
...
plt.plot(X_trainTariff, regressorTariff.predict(X_trainTariff), color='blue')
plt.title('Crude Oil vs Tariff (Test set)')
plt.xlabel('Crude Oil')
plt.ylabel('Tariff')
plt.show()
